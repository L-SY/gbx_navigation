...
public:
  ...
  bool isGoalReached(LocalPlannerUtil* planner_util, OdometryHelperRos& odom_helper,
  ...
  bool computeVelocityCommandsStopRotate(
      ...
      OdometryHelperRos& odom_helper, const geometry_msgs::PoseStamped& global_pose,
      boost::function<bool(Eigen::Vector3f pos, Eigen::Vector3f vel, Eigen::Vector3f vel_samples)> obstacle_check);
